...
"$CONDA_BIN" run -n "$ENV_NAME" python -m pip install -U "regex>=2025.10.22" "transformers>=4.45.0,<=4.52.4,!=4.46.0,!=4.46.1,!=4.46.2,!=4.46.3,!=4.47.0,!=4.47.1,!=4.48.0,!=4.52.0" "peft>=0.13.0" "accelerate>=0.34.0" "datasets>=2.21.0" "trl>=0.10.0" "safetensors>=0.4.4" "omegaconf>=2.3.0"
